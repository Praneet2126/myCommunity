          ...
          <nav className="hidden lg:flex items-center space-x-1">
            ...
            <Link
              ...
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 relative ${
                location.pathname === '/mylens'
                  ? 'text-purple-600 bg-gradient-to-r from-indigo-200 to-indigo-100'
                  : 'text-gray-900 bg-blue-100 hover:text-purple-600 hover:bg-gradient-to-r hover:from-purple-100 hover:to-indigo-50'
              }`}
            >
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-2">
            ...
            <Link
              to="/mylens"
              onClick={() => setIsMobileMenuOpen(false)}
              className={`block px-4 py-3 rounded-lg text-sm font-semibold transition-all duration-200 relative ${
                location.pathname === '/mylens'
                  ? 'text-purple-600 bg-gradient-to-r from-purple-100 to-indigo-100'
            ...
            >
              <span className="flex items-center gap-2">
                ...
                MyLens
                <span className="absolute top-2 right-2 w-2 h-2 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-full animate-pulse"></span>
              </span>
            </Link>
